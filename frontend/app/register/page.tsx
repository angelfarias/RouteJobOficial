  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userType === 'company') {
        ...
        await userSyncService.syncUserOnRegistration(cred.user);
      }
    ...
    <main className="min-h-screen flex flex-col bg-white text-zinc-900 overflow-x-hidden selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <section className="pt-28 pb-20 flex items-center justify-center px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-5rem)]">
        <div className="max-w-md w-full">
          <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl border border-zinc-200 shadow-2xl p-8 sm:p-9">
            <div className="text-center mb-6">
              <h1 className="text-3xl sm:text-4xl font-bold bg-linear-to-r from-zinc-900 via-zinc-900 to-emerald-600 bg-clip-text text-transparent mb-2 leading-tight">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div className="space-y-3">
                ...
                <div>
                  <input
                    ...
                    className={`w-full bg-white/60 backdrop-blur-sm border rounded-2xl px-4 py-3 text-base text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 transition-all hover:border-zinc-300 ${
              ...
              <button
                ...
                className={`group relative w-full py-3.5 text-base font-bold rounded-2xl overflow-hidden flex items-center justify-center gap-2 transition-all ${
            ...
            <div className="flex items-center justify-center gap-4 mt-5 pt-3 border-t border-zinc-100">
              ...
              <div className="flex items-center gap-1.5 text-xs">
                ...
                <span className="text-zinc-500 font-medium">30s</span>
              </div>
            </div>
          </div>
        </div>
