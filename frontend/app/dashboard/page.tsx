  ...
  return (
    <main className="min-h-screen flex flex-col bg-white text-zinc-900 relative overflow-hidden selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <section className="mx-auto flex max-w-7xl gap-6 px-4 pt-24 pb-10">
        {/* COLUMNA IZQUIERDA */}
        <aside className="w-full max-w-xs rounded-2xl bg-white/90 backdrop-blur-xl p-5 shadow-lg shadow-emerald-100 border border-zinc-200">
          <ErrorBoundary>
            ...
            <button
              ...
              className="mt-2 w-full rounded-xl border border-purple-300 bg-gradient-to-r from-purple-50 to-blue-50 px-3 py-2 text-xs font-semibold text-purple-700 hover:from-purple-100 hover:to-blue-100 transition-all flex items-center justify-center gap-2"
            >
        ...
        <div className="flex-1 space-y-6">
          {/* Hero búsqueda */}
          <div className="rounded-2xl border border-zinc-200 bg-white/90 backdrop-blur-xl p-6 shadow-lg shadow-emerald-100">
            <h1 className="mb-2 text-2xl font-extrabold text-zinc-900">
            ...
            >
              ...
              <button
                ...
                className="rounded-xl border border-emerald-300 bg-emerald-50 px-4 py-2 text-xs font-semibold text-emerald-700 hover:bg-emerald-100 transition-colors"
              >
                Usar mi ubicación
              </button>
              ...
              <button
                ...
                className="rounded-xl bg-zinc-900 px-4 py-2 text-sm font-semibold text-white shadow-md shadow-zinc-900/20 hover:bg-zinc-800 hover:translate-y-[1px] transition-transform"
              >
                Buscar con filtros
              </button>
            </form>
          ...
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 text-xs text-emerald-800 flex items-center justify-between gap-4 shadow-sm">
            <div>
          ...
          {/* Smart Profile Setup */}
          <div className="rounded-2xl border border-purple-200 bg-gradient-to-r from-purple-50 to-blue-50 p-4 text-xs text-purple-800 flex items-center justify-between gap-4 shadow-sm">
            <div>
          ...
          <div className="rounded-2xl border border-blue-200 bg-gradient-to-r from-blue-50 to-purple-50 p-4 text-xs text-blue-800 flex items-center justify-between gap-4 shadow-sm">
            <div>
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white/95 backdrop-blur-xl shadow-lg shadow-zinc-100">
            <div className="flex border-b border-zinc-200 text-sm">
              <button className="flex-1 px-4 py-3 text-center font-semibold text-emerald-600 border-b-2 border-emerald-500">
                Empleos
              </button>
              <button className="flex-1 px-4 py-3 text-center text-zinc-500 hover:text-zinc-800 transition-colors">
                Empresas
              </button>
            </div>
                  ...
                  dashboardData.recentJobs.map((job) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <span className="rounded-full bg-emerald-50 px-2 py-1 text-[11px] font-semibold text-emerald-700 border border-emerald-200">
                          Match {job.matchPercentage}%
                        </span>
                        <button 
                          onClick={() => router.push(`/dashboard/jobs/${job.id}`)}
                          className="rounded-lg bg-zinc-900 px-3 py-2 text-[11px] font-semibold text-white shadow-sm shadow-zinc-900/20 hover:bg-zinc-800"
                        >
                          Ver detalles
                        </button>
                      </div>
        ...
        <aside className="hidden w-72 flex-col gap-4 lg:flex">
          <div className="rounded-2xl border border-zinc-200 bg-white/90 backdrop-blur-xl p-4 text-[11px] text-zinc-600 shadow-md shadow-zinc-100">
          ...
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 text-[11px] text-emerald-800 shadow-sm">
